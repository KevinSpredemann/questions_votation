    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action={{ route('questions.store') }} method="post">
                @csrf
                <div class="mb-4">
                    <label for="question" class="block mb-2.5 text-sm font-medium text-black dark:text-white">
                        Question
                    </label>
                    <textarea name="question" id="question" rows="4"
                        ...
                        placeholder="Ask me a question...">{{ old('question') }}</textarea>
                    @error('question')
                ...
                <button type="reset"
                    class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-slate-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                    Cancel
                </button>
            </form>
        </div>
